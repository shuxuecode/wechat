 ...
 <table id="add_news_table" style="width: 600px;margin-left: 90px;" border="0">
	...
	<tr>
		<td align="left">
			...
			<br>
			<input id="author" name="author" type="text" style="width: 300px" />
		</td>
	</tr>
	...
	<tr>
		<td align="left">
			...
			<br>
			<textarea name="description" id="description" cols="60" rows="2" style="resize:none;"></textarea>
		</td>
	</tr>
	...
	<tr>
		<td align="left"><br>
			...
			<br>
			<textarea name="content" id="content" cols="60" rows="15" style="resize:none;"></textarea>
		</td>
	</tr>
