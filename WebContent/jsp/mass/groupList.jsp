		...
		<div class="easyui-layout" data-options="fit:true">
			...
			<div class="center" data-options="region:'center'" style="height:100%; width:100%; margin:0px;">
				<table id="dg" class="easyui-datagrid" 
                    	data-options="url : '${webroot }/msg/groupDatagrid',queryParams:{},
					...
					<thead>
						<tr>
							...
							<th data-options="field:'modifyTime',width:100,editor:'text'">修改时间</th>
...
<!-- ------新增弹出层-----------  -->
<div id="add" class="easyui-window" title="" data-options="modal:true,closed:true,collapsible:false,minimizable:false,resizable: false" style="width:700px;height:360px;">
...
<div>
	<input type="hidden" id="" value="${webroot }"/>
