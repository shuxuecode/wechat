...
<div id="wrapper" style="height:400px;">
  ...
  <ul class="leftmenu">
    <li><a href="#">公共号管理</a>
      <ul class="sub-menu">
        <li id="tag1"><a href="#" onclick="leftmenu_switchTag('tag1','${webroot }/account/toaccountShow');" class="selectli">公共号管理</a></li>
        <li id="tag2"><a href="#" onclick="leftmenu_switchTag('tag2','${webroot }/account/toroleShow');">角色管理</a></li>
        <li id="tag3"><a href="#" onclick="leftmenu_switchTag('tag3','${webroot }/account/toprivilegeShow');">权限管理</a></li>
      </ul>
    </li>
  </ul>
</div>
  ...
  <div class="center" data-options="region:'center'" style="overflow: hidden;">
      <iframe id="iFrame1" name="iFrame1" width="100%" height="100%" frameborder="0" scrolling="no" src="${webroot }/account/toaccountShow"></iframe>
  </div>
</div>
</body>
