...
<div id="wrapper" style="height:400px;">
  ...
  <ul class="leftmenu">
    <li><a href="#">Menu</a>
      <ul class="sub-menu">
        <li id="tag1"><a href="#" onclick="leftmenu_switchTag('tag1','${webroot }/menu/toMyMenu');" class="selectli">自定义菜单</a></li>
      </ul>
    </li>
  </ul>
</div>
  ...
  <div class="center" data-options="region:'center'" style="/*overflow: hidden;*/">
      <iframe id="iFrame1" name="iFrame1" width="100%" height="100%" frameborder="0" scrolling="auto" src="${webroot }/menu/toMyMenu"></iframe>
  </div>
</div>
</body>
</html>
